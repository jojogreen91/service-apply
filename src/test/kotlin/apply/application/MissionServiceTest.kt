...
@UnitTest
class MissionServiceTest : FreeSpec({
    ...
    "해당 평가에 이미 등록된 과제가 있는 경우 예외를 던진다" {
        val missionData = createMissionData()
        every { evaluationRepository.existsById(any()) } returns true
    ...
    "특정 모집에 해당하는 나의 숨겨지지 않은 과제들을 조회한다" {
