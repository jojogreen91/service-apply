...
internal class EvaluationTargetRestControllerTest : RestControllerTest() {
    ...
    init {
        ...
        "이전 평가와 평가 대상자 존재 여부를 통해 저장하거나 갱신한다 " {
                ...
                .andDo(
                    document(
                        ...
                        responseFields(
                            ...
                            fieldWithPath("body.evaluationTarget.note").type(JsonFieldType.STRING)
                            ...
                            fieldWithPath("body.evaluationItems.[].evaluationId").type(JsonFieldType.NUMBER)
                                .description("평가 ID"),
                            fieldWithPath("body.evaluationItems.[].id").type(JsonFieldType.NUMBER)
                                .description("평가 항목 ID")
                        )
                    )
                )
        }
